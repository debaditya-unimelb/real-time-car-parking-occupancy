...
An upcoming recent work that fine-tunes deep networks and automatically delineates the parking slots can be found at https://github.com/DebadityaRMIT/Parking.
